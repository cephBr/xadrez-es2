...
public class FuncaoAvaliacao {
    ...
    public int quantidadePecas(Tabuleiro tab, String corLado){
    ...
    public String retornaTipoDePeca(Tabuleiro tab,int x,int y){
    ...
    public int quantidadePecasEspecificas(Tabuleiro tab, String cor ,String tipo){
    ...
    public int estimativaPorForca(Tabuleiro tab,String corLado){
    ...
    public int estimativaPorOpcoesDeMovimento(Tabuleiro tab, String corLado){
         int forca = 0;
    ...
    public int estimativaPorPosicao(Tabuleiro tab,String corLado){
        int forca = 0;
    ...
    public int calcularAvaliacao(Tabuleiro tab, String corLado){
    ...
    public int calcularAvaliacaoComparativa(Tabuleiro tab){
        int ladoPreto; 
        int ladoBranco;
        int resultado;
