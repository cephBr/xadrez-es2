...
public class TelaJogo implements InterfaceTela{
    ...
    public void carregar() {
         ...
         pecas.add(new Cavalo(1,0,173,113,3,"preto",Constantes.CAVALO_PRETO));
         tabuleiro.setPeça(1,0,pecas.get(1));
         pecas.add(new Bispo(2,0,229,113,2,"preto",Constantes.BISPO_PRETO));
         ...
         pecas.add(new Bispo(5,0,395,113,8,"preto",Constantes.BISPO_PRETO));
         tabuleiro.setPeça(5,0,pecas.get(5));
         pecas.add(new Cavalo(6,0,450,113,9,"preto",Constantes.CAVALO_PRETO));
         tabuleiro.setPeça(6,0,pecas.get(6));
         pecas.add(new Torre(7,0,506,113,7,"preto",Constantes.TORRE_PRETO));
         tabuleiro.setPeça(7,0,pecas.get(7));
         pecas.add(new Peao(0,1,115,158,0,"preto",Constantes.PEAO_PRETO));
         tabuleiro.setPeça(0,1,pecas.get(8));
         pecas.add(new Peao(1,1,171,158,6,"preto",Constantes.PEAO_PRETO));
         tabuleiro.setPeça(1,1,pecas.get(9));
         pecas.add(new Peao(2,1,228,158,12,"preto",Constantes.PEAO_PRETO));
         tabuleiro.setPeça(2,1,pecas.get(10));
         pecas.add(new Peao(3,1,284,158,18,"preto",Constantes.PEAO_PRETO));
         tabuleiro.setPeça(3,1,pecas.get(11));
         pecas.add(new Peao(4,1,341,158,24,"preto",Constantes.PEAO_PRETO));
         tabuleiro.setPeça(4,1,pecas.get(12));
         pecas.add(new Peao(5,1,396,158,30,"preto",Constantes.PEAO_PRETO));
         tabuleiro.setPeça(5,1,pecas.get(13));
         pecas.add(new Peao(6,1,451,158,36,"preto",Constantes.PEAO_PRETO));
         tabuleiro.setPeça(6,1,pecas.get(14));
         pecas.add(new Peao(7,1,508,158,42,"preto",Constantes.PEAO_PRETO));
         tabuleiro.setPeça(7,1,pecas.get(15));
         
         
         pecas.add(new Peao(0,6,99,412,48,"branco",Constantes.PEAO_BRANCO));
         tabuleiro.setPeça(0,6,pecas.get(16));
         pecas.add(new Peao(1,6,159,412,54,"branco",Constantes.PEAO_BRANCO));
         tabuleiro.setPeça(1,6,pecas.get(17));
         pecas.add(new Peao(2,6,220,412,60,"branco",Constantes.PEAO_BRANCO));
         tabuleiro.setPeça(2,6,pecas.get(18));
         pecas.add(new Peao(3,6,281,412,66,"branco",Constantes.PEAO_BRANCO));
         tabuleiro.setPeça(3,6,pecas.get(19));
         pecas.add(new Peao(4,6,341,412,72,"branco",Constantes.PEAO_BRANCO));
         tabuleiro.setPeça(4,6,pecas.get(20));
         pecas.add(new Peao(5,6,404,412,78,"branco",Constantes.PEAO_BRANCO));
         tabuleiro.setPeça(5,6,pecas.get(21));
         pecas.add(new Peao(6,6,464,412,84,"branco",Constantes.PEAO_BRANCO));
         tabuleiro.setPeça(6,6,pecas.get(22));
         pecas.add(new Peao(7,6,526,412,90,"branco",Constantes.PEAO_BRANCO));
         tabuleiro.setPeça(7,6,pecas.get(23));
         pecas.add(new Torre(0,7,94,471,13,"branco",Constantes.TORRE_BRANCO));
         tabuleiro.setPeça(0,7,pecas.get(24));
         pecas.add(new Cavalo(1,7,157,471,15,"branco",Constantes.CAVALO_BRANCO));
         tabuleiro.setPeça(1,7,pecas.get(25));
         pecas.add(new Bispo(2,7,220,471,14,"branco",Constantes.BISPO_BRANCO));
         tabuleiro.setPeça(2,7,pecas.get(26));
         pecas.add(new Dama(3,7,281,471,10,"branco",Constantes.DAMA_BRANCO));
         tabuleiro.setPeça(3,7,pecas.get(27));
         pecas.add(new Rei(4,7,343,471,11,"branco",Constantes.REI_BRANCO));
         tabuleiro.setPeça(4,7,pecas.get(28));
         pecas.add(new Bispo(5,7,405,471,20,"branco",Constantes.BISPO_BRANCO));
         tabuleiro.setPeça(5,7,pecas.get(29));
         pecas.add(new Cavalo(6,7,467,471,21,"branco",Constantes.CAVALO_BRANCO));
         tabuleiro.setPeça(6,7,pecas.get(30));
         pecas.add(new Torre(7,7,529,471,19,"branco",Constantes.TORRE_BRANCO));
